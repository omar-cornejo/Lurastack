...
resource "google_scc_v2_project_mute_config" "this" {
  ...
  location           = ""     # string | optional | location Id is provided by project. If not provided, Use glo…
  ...
  # name               = ""     # string | computed | Name of the mute config. Its format is projects/{project}/lo…
