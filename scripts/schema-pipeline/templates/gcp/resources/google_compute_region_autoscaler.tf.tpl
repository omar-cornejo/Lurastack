...
resource "google_compute_region_autoscaler" "this" {
  ...
  region             = ""     # string | optional+computed | URL of the region where the instance group resides.
  ...
  autoscaling_policy { # list [1..1]
    ...
    metric { # list
      ...
      filter                     = ""     # string | optional | A filter string to be used as the filter string for a Stackd…
      single_instance_assignment = 0      # number | optional | If scaling is based on a per-group metric value that represe…
