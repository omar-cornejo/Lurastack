...
resource "google_compute_per_instance_config" "this" {
  ...
  instance_group_manager           = ""     # string | required | The instance group manager this instance config is part of.
  ...
  zone                             = ""     # string | optional+computed | Zone where the containing instance group manager is located
