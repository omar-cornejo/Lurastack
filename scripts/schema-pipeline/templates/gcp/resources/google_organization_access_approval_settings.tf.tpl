...
resource "google_organization_access_approval_settings" "this" {
  ...
  organization_id                 = ""     # string | required | ID of the organization of the access approval settings.
  ...
  # ancestor_has_active_key_version = false  # bool | computed | This field will always be unset for the organization since o…
  # enrolled_ancestor               = false  # bool | computed | This field will always be unset for the organization since o…
  # invalid_key_version             = false  # bool | computed | If the field is true, that indicates that there is some conf…
  # name                            = ""     # string | computed | The resource name of the settings. Format is "organizations/…
