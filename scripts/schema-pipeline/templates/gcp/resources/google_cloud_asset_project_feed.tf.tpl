...
resource "google_cloud_asset_project_feed" "this" {
  ...
  billing_project = ""     # string | optional | The project whose identity will be used when sending message…
  content_type    = ""     # string | optional | Asset content type. If not specified, no content but the ass…
  id              = ""     # string | optional+computed
  project         = ""     # string | optional+computed

  # name            = ""     # string | computed | The format will be projects/{projectNumber}/feeds/{client-as…
