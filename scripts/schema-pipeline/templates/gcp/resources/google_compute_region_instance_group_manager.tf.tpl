...
resource "google_compute_region_instance_group_manager" "this" {
  ...
  distribution_policy_target_shape = ""     # string | optional+computed | The shape to which the group converges either proactively or…
  distribution_policy_zones        = []     # set(string) | optional+computed | The distribution policy for this managed instance group. You…
  ...
  region                           = ""     # string | optional+computed | The region where the managed instance group resides.
  ...
  update_policy { # list [0..1]
    ...
    instance_redistribution_type   = ""     # string | optional | The instance redistribution policy for regional managed inst…
    ...
    replacement_method             = ""     # string | optional | The instance replacement method for regional managed instanc…
