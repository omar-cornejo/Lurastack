...
resource "google_scc_v2_folder_mute_config" "this" {
  ...
  folder             = ""     # string | required | The folder whose Cloud Security Command Center the Mute Conf…
  ...
  location           = ""     # string | optional | location Id is provided by folder. If not provided, Use glob…
