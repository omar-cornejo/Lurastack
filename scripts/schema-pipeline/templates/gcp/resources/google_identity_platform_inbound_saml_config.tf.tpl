...
resource "google_identity_platform_inbound_saml_config" "this" {
  ...
  idp_config { # list [1..1]
    ...
    idp_certificates { # list [1..*]
      x509_certificate = ""     # string | optional | The IdP's x509 certificate.
  ...
  sp_config { # list [1..1]
    callback_uri    = ""     # string | optional | Callback URI where responses from IDP are handled. Must star…
    sp_entity_id    = ""     # string | optional | Unique identifier for all SAML entities.
