...
resource "google_project_access_approval_settings" "this" {
  ...
  project_id                      = ""     # string | required | ID of the project of the access approval settings.
  ...
  project                         = ""     # string | optional+DEPRECATED | Project id.
  ...
  # name                            = ""     # string | computed | The resource name of the settings. Format is "projects/{proj…
