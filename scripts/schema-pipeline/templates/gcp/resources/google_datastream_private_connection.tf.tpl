...
resource "google_datastream_private_connection" "this" {
  ...
  create_without_validation = false  # bool | optional | If set to true, will skip validations.
  ...
  vpc_peering_config { # list [1..1]
    ...
    vpc    = ""     # string | required | Fully qualified name of the VPC that Datastream will peer to…
