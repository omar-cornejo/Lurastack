...
resource "google_scc_project_custom_module" "this" {
  ...
  display_name     = ""     # string | required | The display name of the Security Health Analytics custom mod…
  enablement_state = ""     # string | required | The enablement state of the custom module. Possible values: …
