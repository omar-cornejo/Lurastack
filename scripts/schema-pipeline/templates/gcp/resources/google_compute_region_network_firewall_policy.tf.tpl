...
resource "google_compute_region_network_firewall_policy" "this" {
  ...
  region                            = ""     # string | optional+computed | The region of this resource.
  ...
  # region_network_firewall_policy_id = ""     # string | computed | The unique identifier for the resource. This identifier is d…
